...
Follow steps above in order. Do not improvise directory structure; the CLI creates it exactly
right. If `vault check` fails after setup, use the **vault-lint** skill to diagnose.
